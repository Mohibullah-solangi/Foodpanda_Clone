...
dishes.get("/Dishes", upload.single("Image"), async (req, res) => {
...
dishes.post("/Dishes", upload.single("Image"), async (req, res) => {
  console.log("router post path");
...
dishes.patch("/Dishes/:id", async (req, res) => {
...
dishes.put("/Dishes/:id", async (req, res) => {
...
dishes.delete("/Dishes", async (req, res) => {
  console.log("router post path");
